...
namespace LibraryManagementSystem {
    ...
    public partial class logindbDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserTblDataTable : global::System.Data.TypedTableBase<UserTblRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserTblRow AddUserTblRow(string user_name, string contact_number, string program, string level, string role, string password) {
        ...
        public partial class UserTblRow : global::System.Data.DataRow {
            ...
            public string user_name {
                get {
                    return ((string)(this[this.tableUserTbl.user_nameColumn]));
                }
                set {
                    this[this.tableUserTbl.user_nameColumn] = value;
                }
            }
            ...
            public string contact_number {
                get {
                    return ((string)(this[this.tableUserTbl.contact_numberColumn]));
                }
                set {
                    this[this.tableUserTbl.contact_numberColumn] = value;
                }
            }
            ...
            public string program {
                get {
                    return ((string)(this[this.tableUserTbl.programColumn]));
                }
                set {
                    this[this.tableUserTbl.programColumn] = value;
                }
            }
            ...
            public string level {
                get {
                    return ((string)(this[this.tableUserTbl.levelColumn]));
                }
                set {
                    this[this.tableUserTbl.levelColumn] = value;
                }
            }
            ...
            public string role {
                get {
                    return ((string)(this[this.tableUserTbl.roleColumn]));
                }
                set {
                    this[this.tableUserTbl.roleColumn] = value;
                }
            }
...
namespace LibraryManagementSystem.logindbDataSet1TableAdapters {
    ...
    public partial class UserTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[UserTbl] WHERE (([user_Id] = @Original_user_Id) AND ([user_name] = @Original_user_name) AND ([contact_number] = @Original_contact_number) AND ([program] = @Original_program) AND ([level] = @Original_level) AND ([role] = @Original_role) AND ([password] = @Original_password))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[UserTbl] ([user_name], [contact_number], [program], [level], [role], [password]) VALUES (@user_name, @contact_number, @program, @level, @role, @password);
SELECT user_Id, user_name, contact_number, program, level, role, password FROM UserTbl WHERE (user_Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserTbl] SET [user_name] = @user_name, [contact_number] = @contact_number, [program] = @program, [level] = @level, [role] = @role, [password] = @password WHERE (([user_Id] = @Original_user_Id) AND ([user_name] = @Original_user_name) AND ([contact_number] = @Original_contact_number) AND ([program] = @Original_program) AND ([level] = @Original_level) AND ([role] = @Original_role) AND ([password] = @Original_password));
SELECT user_Id, user_name, contact_number, program, level, role, password FROM UserTbl WHERE (user_Id = @user_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_Id, user_name, contact_number, program, [level], role, password FROM " +
                "dbo.UserTbl";
        ...
        public virtual int Fill(logindbDataSet1.UserTblDataTable dataTable) {
        ...
        public virtual logindbDataSet1.UserTblDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            logindbDataSet1.UserTblDataTable dataTable = new logindbDataSet1.UserTblDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(logindbDataSet1.UserTblDataTable dataTable) {
        ...
        public virtual int Delete(int Original_user_Id, string Original_user_name, string Original_contact_number, string Original_program, string Original_level, string Original_role, string Original_password) {
        ...
        public virtual int Insert(string user_name, string contact_number, string program, string level, string role, string password) {
            if ((user_name == null)) {
        ...
        public virtual int Update(string user_name, string contact_number, string program, string level, string role, string password, int Original_user_Id, string Original_user_name, string Original_contact_number, string Original_program, string Original_level, string Original_role, string Original_password, int user_Id) {
            if ((user_name == null)) {
                throw new global::System.ArgumentNullException("user_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string user_name, string contact_number, string program, string level, string role, string password, int Original_user_Id, string Original_user_name, string Original_contact_number, string Original_program, string Original_level, string Original_role, string Original_password) {
            return this.Update(user_name, contact_number, program, level, role, password, Original_user_Id, Original_user_name, Original_contact_number, Original_program, Original_level, Original_role, Original_password, Original_user_Id);
        }
    }
